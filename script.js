...
document.querySelector("#page2>h1").textContent.split("").forEach(function(abcd){
    clutter += `<span>${abcd}</span>`
...
document.querySelector("#page4>h1").textContent.split("").forEach(function(abcd){
    clutter += `<span>${abcd}</span>`
